    ...
    return (
        <>
            ...
            <div className="font-poppins scroll-smooth">
                <div className='relative bg-[url(./assets/SalamonBharathi/FirstStatic.jpg)] bg-center  h-screen bg-cover flex justify-center items-center '>

                    <h1 className=" font-bold font-poppins tracking-wider text-white md:text-[3em] text-[1.5em] cursor-none"> SALAMON & BHARATHI </h1>
                ...
                <div className="grid grid-cols-1 mt-10 md:grid-cols-3 md:w-1/2 md:mx-auto">
                    {images.map((image, index) => (
                        <img
                            ...
                            src={image}
                            alt={`photo-${index}`}
                            className="object-cover w-full cursor-pointer h-60 hover:blur-sm"
                ...
                <div className='mt-24 '>
                    ...
                    <div className='mx-auto mt-10 text-center md:w-1/3 font-extralight'>
                ...
                <div className='p-5 mt-24 bg-[#f1f1f1]'>
                    <div className='hidden grid-rows-1 mx-16 md:grid md:grid-cols-6'>
                    ...
                    <div className='flex flex-col justify-between mt-24 md:flex-row '>
                        ...
                        <div className='flex flex-col items-center justify-center text-sm items font-extralight'>
                        ...
                        <div className='flex flex-col gap-2 cursor-pointer '>
                            <div className='text-sm text-center underline font-extralight underline-offset-2'>
                                Contact Us
                            </div>
                        ...
                        <div className='italic text-center cursor-pointer md:text-right font-extralight '>
                            @anodeweddings
                        </div>
                    </div>
                </div>
...
export default SalamonBharathiAlbum
